...
/**
 * Retrieves the path to the engine model file.
 *
 * @return The file path as a string.
 */
std::string get_engine_path(void);
 ...
 */
std::vector<cudla_lightnet::Colormap> get_seg_colormap(void);
...
// For subnet
/**
 * Retrieves the engine path for the subnet model.
 *
 * @return The engine model path as a string.
 */
std::string get_subnet_engine_path(void);

...
public:
  ...
  std::vector<BBoxInfo> decodeTensor(const int imageIdx, const int imageH, const int imageW,  const int inputH, const int inputW, const int *anchor, const int anchor_num, const __half *output, const int gridW, const int gridH, const int gridW_unpad);
